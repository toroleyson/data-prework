...
>>> for i in range (3, len(temperatures_C)):
    if (temperatures_C [i-3] > 70) & (temperatures_C [i-2] > 70) & (temperatures_C [i-1] > 70) & (temperatures_C [i] > 70):
        consecutive4_over70 = consecutive4_over70 + 1

        
>>> ##3. Make the decision!
>>> change_system = 0
>>> if consecutive4_over70 > 0:
    change_system = change_system + 1
...
>>> print ("The average value of the temperature lists in ºC:", statistics.mean(temperatures_C))
The average value of the temperature lists in ºC: 62.833333333333336
>>> print ("The average value of the temperature lists in ºF:", statistics.mean(temperatures_F))
The average value of the temperature lists in ºF: 145.1
>>> ##The relation between the average temperature in ºC and ºF is that in ºF is greater, and it's the result of multiplying ºC * 1.8 + 32, and it´s more than dobule.
>>> 
>>> ##5. Find the standard deviation of the temperature lists (ºC and ºF). What is the relation between both standard deviations?
>>> print ("The standard deviation of the temperature lists in ºC:", statistics.pstdev(temperatures_C))
The standard deviation of the temperature lists in ºC: 14.633485192833897
>>> print ("The standard deviation of the temperature lists in ºF:", statistics.pstdev(temperatures_F))
The standard deviation of the temperature lists in ºF: 26.340273347101014
>>> ##The relation between the standard deviation of the temperature in ºC and ºF is that in ºF is greater, but not more than dobule as in the average temperatures.
>>> 
